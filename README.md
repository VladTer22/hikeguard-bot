...
- Second strike — permanent ban with message history revocation
...
| `BAN_ON_STRIKE` | `2` | Number of strikes before permanent ban |
| `AUTO_DELETE_SERVICE_SEC` | `300` | Auto-delete service messages after N seconds |
